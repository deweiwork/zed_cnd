...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../cnt.srcs/sources_1/bd/design_1/ipshared/1b7e/hdl/verilog" +incdir+"$ref_dir/../../../../cnt.srcs/sources_1/bd/design_1/ipshared/122e/hdl/verilog" +incdir+"$ref_dir/../../../../cnt.srcs/sources_1/bd/design_1/ipshared/7d3c/hdl/verilog" +incdir+"$ref_dir/../../../../cnt.srcs/sources_1/bd/design_1/ipshared/c45e/hdl/verilog" \
    "$ref_dir/../../../bd/design_1/ip/design_1_cnt_0_0/sim/design_1_cnt_0_0.v" \
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/dewei/WorkSpace/zedBoard/cnt/cnt.cache/compile_simlib/vcs"
  fi
